...
namespace LCWeb.Shared.DTOs.DraftLCDTO
{
    public class CreateDraftLCSectionDTO
    {
        //SECTION 1
        ...
        public DateTime S2DateOfExpiry { get; set; } = DateTime.Now;
        ...
        public DateTime S7LatestShipDate { get; set; } = DateTime.Now;
